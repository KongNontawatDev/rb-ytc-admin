...
interface BookingListPageHeaderProps {
  title: string;
...
export const BookingListPageHeader: React.FC<BookingListPageHeaderProps> = ({
  title,
  icon: Icon,
  onClearFilter,
  onToggleSearch,
  ...
  return (
    <Flex justify="space-between" align="end" wrap gap={10}>
      ...
      <div className="flex justify-start lg:justify-end items-center gap-2 flex-wrap">
        ...
        />
        <ButtonCreate
          title={t('common:create', { data: t('booking_list:title') })}
